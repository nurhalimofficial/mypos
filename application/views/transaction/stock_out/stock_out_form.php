        ...
        <div class="box-body">
            <div class="col-md-4 col-md-offset-4">
                ...
                <form action="<?=site_url('stock/process')?>" method="post">
                    ...
                    <div class="form-group">
                        <label>Info *</label>                        
                        <input type="text" name="detail" id="item_name" class="form-control" placeholder="Rusak / hilang / kadaluarsa / etc">                        
                    </div>
                    <div class="form-group">
                        <label>Qty *</label>                        
                        <input type="text" name="qty" id="item_name" class="form-control" required>                        
                    </div>

                    <div class="form-group">
                        <button type="submit" name="out_add" class="btn btn-success btn-falt">
