<html moznomarginboxes mozdisallowselectiononprint>
    <head>
        <title> PW.ID - Print Nota</title>
        <style type="text/css">
            html {font-family: "Vardana, Arial"; }
            .content {
                width:80mm;
                font-size: 12px;
                padding: 5px;
            ...
            <div class="transaction">
                <table class="transaction-table" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td style="border-top:1px dashed; text-align:right; padding-top:5px 0"><?=indo_currency($sale->cash)?></td>
                    </tr>
                    <tr>
                        <td colspan="2"></td>
