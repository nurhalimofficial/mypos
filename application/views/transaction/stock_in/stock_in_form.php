        ...
        <div class="box-body">
            <div class="col-md-4 col-md-offset-4">
                ...
                <form action="<?=site_url('stock/process')?>" method="post">
                    ...
                    <div class="form-group">
                        <label>Detail </label>                        
                        <input type="text" name="detail" id="item_name" class="form-control" placeholder="Kulakan / Tambahan / etc">                        
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button type="submit" name="in_add" class="btn btn-success btn-falt">
