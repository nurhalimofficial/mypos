...
<head>
    ...
    <title>Panca Warna Indonesia</title>
    ...
    <div class="wrapper">
      <header class="main-header">
        <a href="<?=base_url('dashboard')?>" class="logo">
          <span class="logo-mini"><b>PW</b> ID</span>
          <span class="logo-lg"><b>Panca Warna </b>ID</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown messages-menu">
                ...
                <ul class="dropdown-menu">
                  <li class="header">You have 3 task</li>
                  <li>
                    <ul class="menu">
                      <li>
                        <a href="#">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li <?=$this->uri->segment(1) == 'customer' ? 'class="active"' : ''?>>
              <a href="<?=site_url('customer')?>"><i class="fa fa-users"></i> <span>Costumers</span></a>
              </a>
            </li>
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>Version</b> 29 Tahun
        </div>
        <strong>Copyright &copy; 1991-2020 <a href="https://pancawarna.id">Panca Warna Indonesia</a>.</strong> All rights
        reserved.
      </footer>
    </div>
  </div>
